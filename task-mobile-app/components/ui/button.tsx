...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      ...
      size: {
        default: cn('h-10 px-4 sm:h-9'),
        sm: cn('h-8 px-3 sm:h-7'),
        lg: cn('h-12 px-6 sm:h-11'),
        icon: 'h-9 w-9',
      },
    },
    defaultVariants: {
...
export type ButtonProps = React.ComponentPropsWithoutRef<typeof Pressable> & VariantProps<typeof buttonVariants>;
