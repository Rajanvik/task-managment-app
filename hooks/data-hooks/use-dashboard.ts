...
import { dashboardService, DashboardAnalytics } from '@/services/dashboard';
import { TQueryOptions, TQueryReturnType } from './types';
...
export const DashboardDataHook: IDashboardDataHook = {
  ...
  useDashboardAnalytics(options) {
    return useQuery({
      ...
      queryFn: dashboardService.getAnalytics, // direct call analytics metrics response
      ...options,
    });
  }
};
